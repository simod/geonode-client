...
GeoNode.CartSearchTable = Ext.extend(Ext.util.Observable, {
    ...
    mapLinkLabelText: "UT:View this Cartography",
    previousText: 'UT: Prev',
    nextText: 'UT: Next',
    ofText: 'UT: of',
    noResultsText: 'UT: Your search did not match any items.',
    searchLabelText: 'UT: Search Cartography',
    ...
    doLayout: function() {
        ...
        var tpl = new Ext.Template('<p><b>' + this.mapAbstractLabelText + ':</b> {abstract}</p>'+ '<p><a href="/cartography/{name}">' + this.mapLinkLabelText + '</a></p>');
